...
public class MainWindowFunc : MainWindow
{
...
[EditorApp( "Upgraded Shader Graph", "gradient", "edit shaders" )]
public class MainWindowShader : MainWindow
{
...
public class MainWindow : DockWindow
{
	...
	protected override void BuildDefaultLayout()
	{
		...
		DockManager.SetSplitterProportions( preview, 0.3f, 0.7f );
		...
		DockManager.SetSplitterProportions( properties, 0.5f, 0.5f );
